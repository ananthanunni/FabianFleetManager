    ...
    $.fn.jqGrid = function (pin) {
        ...
        return this.each(function () {
            ...
            var p = $.extend(true, {
                ...
                idPrefix: "",
                multiSort: false,
                inValidPageIndexMessage: 'Invalid Page Index.'
            }, $.jgrid.defaults, pin || {});
            var ts = this, grid = {
                headers: [],
                cols: [],
            ...
            setPager = function (pgid, tp) {
                ...
                if (dir === "rtl") { pgl += str; }
                if (ts.p.pginput === true) { pginp = "<td dir='" + dir + "'>" + $.jgrid.format(ts.p.pgtext || "", "<input class='ui-pg-input numwospc' id='txt_" + $.jgrid.jqID(pgid) + "' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(pgid) + "'></span>") + "</td>"; }
                if (ts.p.pgbuttons === true) {
                    ...
                    $('input.ui-pg-input', "#" + pgcnt).keypress(function (e) {
                        ...
                        if (key === 13) {
                            ...
                            if ($(this).val() > ts.p.lastpage) {
                                $(this).val(ts.p.page);
                                jAlert(ts.p.inValidPageIndexMessage, this.id);
                                return false;
                            }
