...
!function ($) {
    ...
    * ================================== */
    var WTimepicker = function (element, options) {
        this.$element = $(element);
        this.options = $.extend({}, $.fn.wtimepicker.defaults, options, this.$element.data());
    ...
    WTimepicker.prototype = {

        constructor: WTimepicker
    ...
    * =========================== */
    ...
    $.fn.wtimepicker = function (option) {
        return this.each(function () {
            var $this = $(this)
            , data = $this.data('timepicker')
            , options = typeof option == 'object' && option;
            if (!data) {
                $this.data('timepicker', (data = new WTimepicker(this, options)));
            }
    ...
    $.fn.wtimepicker.Constructor = WTimepicker
